...
const {
  validateCampground,
  validateReview,
} = require("../validations/campgroundValidation");
...
const {
  isCampgroundOwner,
  isReviewOwner,
} = require("../middleware/campgroundMiddleware");
...
router.post(
  ...
  validateCampground,
  passportJWT,
  CampgroundController.postNewCampground
...
router.post(
  ...
  passportJWT,
  validateReview,
  CampgroundController.postNewReview
); //POST a new review
router.delete(
  "/:id/reviews/:reviewId",
  passportJWT,
...
router.put(
  ...
  isReviewOwner,
  validateReview,
  CampgroundController.editReview
); //Edit a review
