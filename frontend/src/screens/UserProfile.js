  ...
  return (
    <div className={classes.root}>
      ...
      <TabPanel value={value} index={0}>
        <Row>
          {userProfile && userProfile.campgrounds.length === 0 ? (
            <p>No Places posted</p>
          ) : null}
          {userProfile &&
...
const UserProfile = ({ match, history }) => {
  ...
  return (
    <div>
      {userProfile && <Meta title={userProfile.user.username} />}
      ...
      {loading ? (
        ...
        <>
          ...
          <Row className="mt-5">
            {userProfile && (
              <SimpleTabs profile={userProfile} history={history} />
            )}
          </Row>
        </>
      ) : null}
