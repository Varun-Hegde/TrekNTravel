...
//SET THE DETAILS ABOUT ALL THE PLACES ON MY FEED
export const placeListMyFeedReducer = (state = { places: [], addedPlace: false }, action) => {
	switch (action.type) {
		case PLACE_LIST_MY_FEED_REQUEST:
			return {
				...state,
				loading: true,
				places: [],
		...
		case PLACE_LIST_MY_FEED_SUCCESS:
			return {
				...state,
				loading: false,
				places: action.payload.campgrounds,
